# Ember Validations for the browser

Ember Validations for the Browser (via Bower)

Can be used with [ember-easyform-cli](https://github.com/kristianmandrup/ember-easyform)
...
```json
{
  "devDependencies": {
    // others ...
    "ember-validations": "git://github.com/kristianmandrup/ember-validations.git#master"
  }
}
```
